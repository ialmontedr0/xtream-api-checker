...
from app.models.xtream.dto import XtreamResponseDTO
from app.models.request.dto import XtreamRequestDTO
...
class XtreamService:
    ...
    def _build_url(self, data: XtreamRequestDTO) -> str:
        ...
        return f"{server}/player_api.pho?username={data.username}&password={data.password}"
